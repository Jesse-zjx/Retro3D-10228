...
class ComENet(nn.Module):
    ...
    def _forward(self, src_pos, src_z, src_index):
        pos, z, batch = src_pos, src_z, src_index
        # batch = data.batch
        # z = data.z.long()
        # pos = data.pos
        num_nodes = z.size(0)
    ...
    def forward(self, src_pos, src_z, src_index):
        return self._forward(src_pos, src_z, src_index)